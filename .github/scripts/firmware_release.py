...
FIRMWARE_TARGETS: tuple[FirmwareTarget, ...] = (
    FirmwareTarget("RTC_PCF8563", "examples/RTC_PCF8563", title="RTC PCF8563"),
    FirmwareTarget("LowPower_DeepSleep", "examples/LowPower_DeepSleep", title="Low Power Deep Sleep"),
    FirmwareTarget(
        "MicRecordToSD_E1001",
        "examples/MicRecordToSD",
        devices=("E1001", "E1002"),
    ...
    FirmwareTarget("Buzzer_Control", "examples/Buzzer_Control", title="Buzzer Control"),
    FirmwareTarget("Buzzer_Music", "examples/Buzzer_Music", title="Buzzer Music"),
    FirmwareTarget("UserButtons", "examples/UserButtons", title="User Buttons"),
    FirmwareTarget("Battery_Monitor", "examples/Battery_Monitor", title="Battery Monitor"),
    FirmwareTarget("MicroSD_ListFiles", "examples/MicroSD_ListFiles", title="MicroSD List Files"),
    FirmwareTarget(
        "GxEPD2_reTerminal_E1001",
        "examples/GxEPD2_reTerminal_E1001",
        devices=("E1001",),
        needs_gxepd2=True,
    ...
    FirmwareTarget(
        ...
        "examples/GxEPD2_reTerminal_E1002",
        devices=("E1002",),
        needs_gxepd2=True,
    ...
    FirmwareTarget(
        ...
        "examples/GxEPD2_reTerminal_E1003",
        devices=("E1003",),
        needs_gxepd2=True,
    ...
    FirmwareTarget(
        ...
        "examples/GxEPD2_reTerminal_E1004",
        devices=("E1004",),
        needs_gxepd2=True,
    ...
    FirmwareTarget(
        ...
        "examples/GxEPD2_reTerminal_E1001_Gray4",
        devices=("E1001",),
        needs_gxepd2=True,
    ...
    FirmwareTarget(
        ...
        "examples/Seeed_GFX_E1001_Gray4",
        devices=("E1001",),
        needs_gfx=True,
    ...
    FirmwareTarget(
        ...
        "examples/GxEPD2_reTerminal_E1003_Gray16",
        devices=("E1003",),
        needs_gxepd2=True,
    ...
    FirmwareTarget(
        "SHT4x_Sensor",
        "examples/SHT4x_Sensor",
        needs_sht4x=True,
        title="SHT4x Sensor",
    ),
    FirmwareTarget(
        "SD_ImagePipeline_E1001_BW",
        "examples/SD_ImagePipeline_E1001_BW",
        devices=("E1001",),
        needs_gfx=True,
    ...
    FirmwareTarget(
        ...
        "examples/SD_ImagePipeline_E1001_Gray4",
        devices=("E1001",),
        needs_gfx=True,
    ...
    FirmwareTarget(
        ...
        "examples/SD_ImagePipeline_E1002",
        devices=("E1002",),
        needs_gfx=True,
    ...
    FirmwareTarget(
        ...
        "examples/SD_ImagePipeline_E1003",
        devices=("E1003",),
        needs_gfx=True,
    ...
    FirmwareTarget(
        ...
        "examples/SD_ImagePipeline_E1004",
        devices=("E1004",),
        needs_gfx=True,
    ...
    for firmware_dir in sorted(entry for entry in firmware_root.iterdir() if entry.is_dir()):
        ...
        catalog_items.append(
            FirmwareTarget(
                ...
                path=f"examples/{firmware_dir.name}",
