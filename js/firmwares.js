...
substitutions:
  device_name: reterminal-e
  friendly_name: "reTerminal E"
    ...
    templateOptions: [
      {
        ...
        label: "Wi-Fi + OTA",
        defaultChecked: true,
        description: "Basic Wi-Fi connection and over-the-air updates",
        snippet: `wifi:
  ...
  - platform: esphome
    password: !secret ota_password`,
      },
      {
        ...
        defaultChecked: true,
        description: "Native integration with Home Assistant",
        snippet: `api:
  encryption:
    key: !secret api_encryption_key`,
      ...
      {
        id: "display_ili9341",
        label: "Display (ILI9341 / SPI)",
        defaultChecked: false,
        description: "SPI display for reTerminal E-Series screen",
        snippet: `spi:
  clk_pin: GPIO12
  mosi_pin: GPIO11
...
display:
  - platform: ili9xxx
    ...
    rotation: 0
    lambda: |-
      it.print(0, 0, id(font_default), "Hello reTerminal!");
  ...
  - file: "gfonts://Roboto"
    ...
    size: 20`,
      },
      {
        ...
        defaultChecked: false,
        description: "DHT22 sensor on a configurable GPIO pin",
        snippet: `sensor:
  - platform: dht
    pin: GPIO4
    temperature:
    ...
    update_interval: 60s`,
      ...
      {
        id: "web_server",
        label: "Web Server (debug)",
        defaultChecked: false,
        description: "Built-in HTTP dashboard for debugging",
        snippet: `web_server:
  port: 80`,
      },
    ],
